...
const u8 gText_ExpandedPlaceholder_Lucas[] = _("Lucas");
const u8 gText_ExpandedPlaceholder_Dawn[] = _("Dawn");
const u8 gText_ExpandedPlaceholder_Barry[] = _("Barry");
...
const u8 gText_RowanGiveStarter[] = _("Now choose!\nWhich Pokémon will it be?");
const u8 gText_ConfirmStarterChoice[] = _("INSERT COLORED MON NAME HERE!\nDo you choose this Pokémon?");
const u8 gText_ConfirmStarterChoiceLT[] = _("{COLOR 05}{STR_VAR_2} {STR_VAR_1}{COLOR 02}!\nWill you take this Pokémon?");
const u8 gText_ConfirmStarterChoiceMD[] = _("{COLOR 04}{STR_VAR_2} {STR_VAR_1}{COLOR 02}!\nDo you choose this Pokémon?");
const u8 gText_ConfirmStarterChoiceRT[] = _("{COLOR 08}{STR_VAR_2} {STR_VAR_1}{COLOR 02}!\nIs this the Pokémon for you?");const u8 gText_Pokemon4[] = _("POKéMON"); // Unused

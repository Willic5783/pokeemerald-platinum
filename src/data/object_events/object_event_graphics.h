...
const u32 gObjectEventPic_AceTrainerPt[] = INCBIN_U32("graphics/object_events/pics/people/ace_trainer_pt.4bpp");
const u16 gObjectEventPal_AceTrainerPt[] = INCBIN_U16("graphics/object_events/palettes/ace_trainer_pt.gbapal");

...
// static const u8 sHelperAvatarGfxIds[][GENDER_COUNT] =
{
    ...
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  = {OBJ_EVENT_GFX_LUCAS_NORMAL, OBJ_EVENT_GFX_DAWN_NORMAL},
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_LUCAS_NORMAL, OBJ_EVENT_GFX_DAWN_NORMAL},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_LUCAS_NORMAL, OBJ_EVENT_GFX_DAWN_NORMAL},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_LUCAS_NORMAL, OBJ_EVENT_GFX_DAWN_NORMAL},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_LUCAS_NORMAL, OBJ_EVENT_GFX_DAWN_NORMAL},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_LUCAS_NORMAL, OBJ_EVENT_GFX_DAWN_NORMAL},
    [PLAYER_AVATAR_STATE_VSSEEKER]   = {OBJ_EVENT_GFX_LUCAS_NORMAL, OBJ_EVENT_GFX_DAWN_NORMAL},
};
...
static const u8 sPlayerAvatarGfxToStateFlag[GENDER_COUNT][5][2] =
{
    [MALE] =
    {
        ...
        {OBJ_EVENT_GFX_LUCAS_NORMAL, PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_LUCAS_NORMAL, PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_LUCAS_NORMAL, PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_LUCAS_NORMAL, PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [FEMALE] =
    {
        {OBJ_EVENT_GFX_DAWN_NORMAL, PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_DAWN_NORMAL, PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_DAWN_NORMAL, PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_DAWN_NORMAL, PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_DAWN_NORMAL, PLAYER_AVATAR_FLAG_UNDERWATER},
    }
};

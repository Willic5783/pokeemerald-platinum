...
extern const u16 gObjectEventPal_AceTrainerColdFPt[];
extern const u16 gObjectEventPal_AceTrainerColdMPt[];
extern const u16 gObjectEventPal_AromaLadyPt[];
extern const u16 gObjectEventPal_ArtistPt[];
extern const u16 gObjectEventPal_BabyPt[];
extern const u16 gObjectEventPal_CameramanPt[];
extern const u16 gObjectEventPal_CamperPt[];
extern const u16 gObjectEventPal_ClownPt[];
extern const u16 gObjectEventPal_CollectorPt[];
extern const u16 gObjectEventPal_CyclistFPt[];
extern const u16 gObjectEventPal_CyclistMPt[];
extern const u16 gObjectEventPal_FishermanPt[];
extern const u16 gObjectEventPal_GalacticCyrusPt[];
extern const u16 gObjectEventPal_GalacticGruntFPt[];
extern const u16 gObjectEventPal_GalacticGruntMPt[];
extern const u16 gObjectEventPal_GalacticJupiterPt[];
extern const u16 gObjectEventPal_GalacticMarsPt[];
extern const u16 gObjectEventPal_GalacticSaturnPt[];
extern const u16 gObjectEventPal_GentlemanPt[];
extern const u16 gObjectEventPal_GuitaristPt[];
extern const u16 gObjectEventPal_GymGuyPt[];
extern const u16 gObjectEventPal_HikerPt[];
extern const u16 gObjectEventPal_JoggerMPt[];
extern const u16 gObjectEventPal_LookerPt[];
extern const u16 gObjectEventPal_NDSKidPt[];
extern const u16 gObjectEventPal_NinjaBoyPt[];
extern const u16 gObjectEventPal_NurseJoyPt[];
extern const u16 gObjectEventPal_PicnickerPt[];
extern const u16 gObjectEventPal_PokemonBreederMPt[];
extern const u16 gObjectEventPal_PolicemanPt[];
extern const u16 gObjectEventPal_ProfOakPt[];
extern const u16 gObjectEventPal_RancherPt[];
extern const u16 gObjectEventPal_ReporterPt[];
extern const u16 gObjectEventPal_PokefanFPt[];
extern const u16 gObjectEventPal_SailorPt[];
extern const u16 gObjectEventPal_ScientistFPt[];
extern const u16 gObjectEventPal_ScientistMPt[];
extern const u16 gObjectEventPal_SkierFPt[];
extern const u16 gObjectEventPal_SkierMPt[];
extern const u16 gObjectEventPal_SwimmerFPt[];
extern const u16 gObjectEventPal_SwimmerMPt[];
extern const u16 gObjectEventPal_TealaPt[];
extern const u16 gObjectEventPal_TuberFPt[];
extern const u16 gObjectEventPal_TuberMPt[];
extern const u16 gObjectEventPal_TwinsPt[];
extern const u16 gObjectEventPal_VeteranPt[];
extern const u16 gObjectEventPal_WaiterPt[];
extern const u16 gObjectEventPal_WaitressPt[];
extern const u16 gObjectEventPal_WorkerPt[];
extern const u16 gObjectEventPal_YoungsterPt[];
extern const u16 gObjectEventPal_OldWomanPt[];
extern const u16 gObjectEventPal_WomanSnowPt[];
extern const u16 gObjectEventPal_OldManPt[];
extern const u16 gObjectEventPal_ManSnowPt[];
extern const u16 gObjectEventPal_WomanMiddleAgedPt[];
extern const u16 gObjectEventPal_ManMiddleAgedPt[];
extern const u16 gObjectEventPal_ReceptionistPt[];
extern const u16 gObjectEventPal_FrontierSinglesPt[];
extern const u16 gObjectEventPal_FrontierMultiPt[];
extern const u16 gObjectEventPal_FrontierBoothPt[];
extern const u16 gObjectEventPal_PalmerPt[];
extern const u16 gObjectEventPal_SchoolKidFPt[];
extern const u16 gObjectEventPal_SchoolKidMPt[];
extern const u16 gObjectEventPal_PlazaAttendantFPt[];
extern const u16 gObjectEventPal_PlazaAttendantMPt[];
extern const u16 gObjectEventPal_ExpertFPt[];
extern const u16 gObjectEventPal_JasminePt[];
extern const u16 gObjectEventPal_CashierFPt[];
extern const u16 gObjectEventPal_CashierMPt[];
extern const u16 gObjectEventPal_PokefanMPt[];
extern const u16 gObjectEventPal_RoarkPt[];
extern const u16 gObjectEventPal_GardeniaPt[];
extern const u16 gObjectEventPal_MaylenePt[];
extern const u16 gObjectEventPal_CrasherWakePt[];
extern const u16 gObjectEventPal_FantinaPt[];
extern const u16 gObjectEventPal_ByronPt[];
extern const u16 gObjectEventPal_CandicePt[];
extern const u16 gObjectEventPal_VolknerPt[];
extern const u16 gObjectEventPal_AaronPt[];
extern const u16 gObjectEventPal_BerthaPt[];

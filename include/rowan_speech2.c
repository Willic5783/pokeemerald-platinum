...
#define INTRO_SPECIES SPECIES_BUNEARY
...
struct RowanSpeechResources
{
    void *rowanSpeechBackgroundTiles;
...
static EWRAM_DATA struct RowanSpeechResources *sRowanSpeechResources = NULL;
...
static void Task_RowanSpeech_Init(u8);
static void Task_RowanSpeech_WelcomeToTheWorld(u8);
static void Task_RowanSpeech_ThisWorld(u8);
static void Task_RowanSpeech_ReleaseBunearyFromPokeBall(u8);
static void Task_RowanSpeech_IsInhabitedFarAndWide(u8);
static void Task_RowanSpeech_IStudyPokemon(u8);
static void Task_RowanSpeech_ReturnBunearyToPokeBall(u8);
static void Task_RowanSpeech_TellMeALittleAboutYourself(u8);
static void Task_RowanSpeech_FadeOutRowan(u8);
static void Task_RowanSpeech_AskPlayerGender(u8);
static void Task_RowanSpeech_ShowGenderOptions(u8);
static void Task_RowanSpeech_HandleGenderInput(u8);
static void Task_RowanSpeech_ClearGenderWindows(u8);
static void Task_RowanSpeech_LoadPlayerPic(u8);
static void Task_RowanSpeech_YourNameWhatIsIt(u8);
static void Task_RowanSpeech_FadeOutForPlayerNamingScreen(u8);
static void Task_RowanSpeech_HandleRivalNameInput(u8);
static void Task_RowanSpeech_DoNamingScreen(u8);
static void Task_RowanSpeech_ConfirmName(u8);
static void Task_RowanSpeech_HandleConfirmNameInput(u8);
static void Task_RowanSpeech_FadeOutPlayerPic(u8);
static void Task_RowanSpeech_FadeOutRivalPic(u8);
static void Task_RowanSpeech_FadeInRivalPic(u8);
static void Task_RowanSpeech_AskRivalsName(u8);
static void Task_RowanSpeech_ReshowPlayersPic(u8);
static void Task_RowanSpeech_LetsGo(u8);
static void Task_RowanSpeech_FadeOutBGM(u8);
static void Task_RowanSpeech_SetUpExitAnimation(u8);
static void Task_RowanSpeech_SetUpShrinkPlayerPic(u8);
static void Task_RowanSpeech_ShrinkPlayerPic(u8);
static void Task_RowanSpeech_SetUpDestroyPlatformSprites(u8);
static void Task_RowanSpeech_DestroyPlatformSprites(u8);
static void Task_RowanSpeech_SetUpFadePlayerPicWhite(u8);
static void Task_RowanSpeech_FadePlayerPicWhite(u8);
static void Task_RowanSpeech_FadePlayerPicToBlack(u8);
static void Task_RowanSpeech_WaitForFade(u8);
static void NewGameBirchSpeech_ShowDialogueWindow(u8, u8);

static void Task_RowanSpeech_FreeResources(u8);

static void CB2_ReturnFromNamingScreen(void);
static void CreateBunearySprite(u8);
...
static const u16 sRowanSpeech_Background_Pals[] = INCBIN_U16("graphics/birch_speech/bg_tiles.gbapal"); // Shared by the Controls Guide, Pikachu Intro and Rowan Speech scenes
static const u32 sControlsGuide_PikachuIntro_Background_Tiles[] = INCBIN_U32("graphics/birch_speech/bg_tiles.4bpp.lz");
static const u32 sPikachuIntro_Background_Tilemap[] = INCBIN_U32("graphics/birch_speech/pikachu_intro/tilemap.bin.lz");
static const u32 sRowanSpeech_Background_Tiles[] = INCBIN_U32("graphics/birch_speech/birch_speech_bg.4bpp.lz");
static const u32 sRowanSpeech_Background_Tilemap[] = INCBIN_U32("graphics/birch_speech/birch_speech_bg.bin.lz");
static const u16 sControlsGuide_Tilemap_Page2[] = INCBIN_U16("graphics/birch_speech/controls_guide_page_2.bin");
static const u16 sControlsGuide_Tilemap_Page3[] = INCBIN_U16("graphics/birch_speech/controls_guide_page_3.bin");
static const u16 sRowanSpeech_Leaf_Pal[] = INCBIN_U16("graphics/birch_speech/leaf/pal.gbapal");
static const u32 sRowanSpeech_Leaf_Tiles[] = INCBIN_U32("graphics/birch_speech/leaf/pic.8bpp.lz");
static const u16 sRowanSpeech_Red_Pal[] = INCBIN_U16("graphics/birch_speech/red/pal.gbapal");
static const u32 sRowanSpeech_Red_Tiles[] = INCBIN_U32("graphics/birch_speech/red/pic.8bpp.lz");
static const u16 sRowanSpeech_Rowan_Pal[] = INCBIN_U16("graphics/birch_speech/rowan/pal.gbapal");
static const u32 sRowanSpeech_Rowan_Tiles[] = INCBIN_U32("graphics/birch_speech/rowan/pic.8bpp.lz");
static const u16 sRowanSpeech_Rival_Pal[] = INCBIN_U16("graphics/birch_speech/rival/pal.gbapal");
static const u32 sRowanSpeech_Rival_Tiles[] = INCBIN_U32("graphics/birch_speech/rival/pic.8bpp.lz");
static const u16 sRowanSpeech_Platform_Pal[] = INCBIN_U16("graphics/birch_speech/platform.gbapal");
static const u16 sPikachuIntro_Pikachu_Pal[] = INCBIN_U16("graphics/birch_speech/pikachu_intro/pikachu.gbapal");
static const u32 sRowanSpeech_Platform_Gfx[] = INCBIN_U32("graphics/birch_speech/platform.4bpp.lz");
static const u32 sPikachuIntro_PikachuBody_Gfx[] = INCBIN_U32("graphics/birch_speech/pikachu_intro/body.4bpp.lz");
static const u32 sPikachuIntro_PikachuEars_Gfx[] = INCBIN_U32("graphics/birch_speech/pikachu_intro/ears.4bpp.lz");
static const u32 sPikachuIntro_PikachuEyes_Gfx[] = INCBIN_U32("graphics/birch_speech/pikachu_intro/eyes.4bpp.lz");
...
static const struct CompressedSpriteSheet sRowanSpeech_Platform_SpriteSheet =
{
    .data = sRowanSpeech_Platform_Gfx,
    .size = 0x600,
...
static const struct SpritePalette sRowanSpeech_Platform_SpritePalette =
{
    .data = sRowanSpeech_Platform_Pal,
    .tag = PAL_TAG_PLATFORM
};

static const union AnimCmd sRowanSpeech_PlatformLeft_Anim[] =
{
    ANIMCMD_FRAME( 0, 0),
    ANIMCMD_END
};

static const union AnimCmd sRowanSpeech_PlatformMiddle_Anim[] =
{
    ANIMCMD_FRAME(16, 0),
    ANIMCMD_END
};

static const union AnimCmd sRowanSpeech_PlatformRight_Anim[] =
{
    ANIMCMD_FRAME(32, 0),
    ANIMCMD_END
};

static const union AnimCmd *const sRowanSpeech_PlatformLeft_Anims[] =
{
    sRowanSpeech_PlatformLeft_Anim
};

static const union AnimCmd *const sRowanSpeech_PlatformMiddle_Anims[] =
{
    sRowanSpeech_PlatformMiddle_Anim
};

static const union AnimCmd *const sRowanSpeech_PlatformRight_Anims[] =
{
    sRowanSpeech_PlatformRight_Anim
};

static const struct SpriteTemplate sRowanSpeech_Platform_SpriteTemplates[] =
{
    [PIKACHU_BODY_PLATFORM_LEFT] =
    {
        ...
        .anims = sRowanSpeech_PlatformLeft_Anims,
        .images = NULL,
    ...
    [PIKACHU_EARS_PLATFORM_MIDDLE] =
    {
        ...
        .paletteTag = PAL_TAG_PLATFORM,
        .oam = &gOamData_AffineOff_ObjBlend_32x32,
        .anims = sRowanSpeech_PlatformMiddle_Anims,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
        .callback = SpriteCallbackDummy
    },
    [PIKACHU_EYES_PLATFORM_RIGHT] =
    {
        ...
        .paletteTag = PAL_TAG_PLATFORM,
        .oam = &gOamData_AffineOff_ObjBlend_32x32,
        .anims = sRowanSpeech_PlatformRight_Anims,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
        .callback = SpriteCallbackDummy
    },
...
#define tBunearySpriteId            data[4]
...
static void Task_NewGameScene(u8 taskId)
{
    ...
    case 0:
        ...
        break;
    case 1:
        sRowanSpeechResources = AllocZeroed(sizeof(*sRowanSpeechResources));
    ...
    case 3:
        ...
        SetBgTilemapBuffer(1, sRowanSpeechResources->bg1TilemapBuffer);
        SetBgTilemapBuffer(2, sRowanSpeechResources->bg2TilemapBuffer);
    ...
    case 4:
        ...
        LoadPalette(sRowanSpeech_Background_Pals, BG_PLTT_ID(0), sizeof(sRowanSpeech_Background_Pals));
        LoadPalette(GetTextWindowPalette(2) + 15, BG_PLTT_ID(0), PLTT_SIZEOF(1));
        break;
    case 5:
        sRowanSpeechResources->textSpeed = GetPlayerTextSpeedDelay();
...
static void ControlsGuide_LoadPage1(void)
{
    ...
    sRowanSpeechResources->windowIds[0] = AddWindow(sControlsGuide_WindowTemplates[sRowanSpeechResources->currentPage]);
    PutWindowTilemap(sRowanSpeechResources->windowIds[0]);
    FillWindowPixelBuffer(sRowanSpeechResources->windowIds[0], PIXEL_FILL(0));
    AddTextPrinterParameterized4(sRowanSpeechResources->windowIds[0], FONT_NORMAL, 2, 0, 1, 1, sTextColor_White, 0, gControlsGuide_Text_Intro);
    CopyWindowToVram(sRowanSpeechResources->windowIds[0], COPYWIN_FULL);
...
{
    u8 currWindow = 0;
    u8 page2Or3 = sRowanSpeechResources->currentPage - 1; // 0 if page 2, 1 if page 3
    if (sRowanSpeechResources->currentPage == CONTROLS_GUIDE_PAGE_1)
    {
        ControlsGuide_LoadPage1();
    }
    else
    {
        ...
        {
            sRowanSpeechResources->windowIds[currWindow] = AddWindow(&sControlsGuide_WindowTemplates[sRowanSpeechResources->currentPage][currWindow]);
            PutWindowTilemap(sRowanSpeechResources->windowIds[currWindow]);
            FillWindowPixelBuffer(sRowanSpeechResources->windowIds[currWindow], PIXEL_FILL(0));
            AddTextPrinterParameterized4(sRowanSpeechResources->windowIds[currWindow], FONT_NORMAL, 6, 0, 1, 1, sTextColor_White, 0, sControlsGuide_Pages2And3_Strings[currWindow + page2Or3 * CONTROLS_GUIDE_STRINGS_PER_PAGE]);
            CopyWindowToVram(sRowanSpeechResources->windowIds[currWindow], COPYWIN_FULL);
        }

        if (sRowanSpeechResources->currentPage == CONTROLS_GUIDE_PAGE_2)
    ...
    if (!gPaletteFade.active)
    {
        if(JOY_NEW((A_BUTTON | B_BUTTON)))
        {
            if (JOY_NEW(A_BUTTON))
            {
                ...
                if (sRowanSpeechResources->currentPage < CONTROLS_GUIDE_PAGE_3)
...
static void Task_ControlsGuide_ChangePage(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        switch (sRowanSpeechResources->currentPage)
        {
        ...
        sRowanSpeechResources->currentPage += gTasks[taskId].tDelta;
        if (sRowanSpeechResources->currentPage < NUM_CONTROLS_GUIDE_PAGES)
        {
            for (i = 0; i < numWindows; i++)
            {
                FillWindowPixelBuffer(sRowanSpeechResources->windowIds[i], PIXEL_FILL(0));
                ClearWindowTilemap(sRowanSpeechResources->windowIds[i]);
                CopyWindowToVram(sRowanSpeechResources->windowIds[i], COPYWIN_FULL);
                RemoveWindow(sRowanSpeechResources->windowIds[i]);
                sRowanSpeechResources->windowIds[i] = 0;
            }
...
static void Task_ControlsGuide_Clear(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        ...
        sRowanSpeechResources->windowIds[0] = RGB_BLACK;
        LoadPalette(sRowanSpeechResources->windowIds, BG_PLTT_ID(0), PLTT_SIZEOF(1));
...
static void Task_PikachuIntro_LoadPage1(u8 taskId)
{
    ...
    else
    {
        ...
        sRowanSpeechResources->pikachuIntroTilemap = malloc_and_decompress(sPikachuIntro_Background_Tilemap, &size);
        CopyToBgTilemapBufferRect(1, sRowanSpeechResources->pikachuIntroTilemap, 0, 2, 30, 19);
        CopyBgTilemapBufferToVram(1);
        Free(sRowanSpeechResources->pikachuIntroTilemap);
        sRowanSpeechResources->pikachuIntroTilemap = NULL;
        ...
        sRowanSpeechResources->currentPage = PIKACHU_INTRO_PAGE_1;
...
static void Task_PikachuIntro_HandleInput(u8 taskId)
{
    ...
    case PIKACHU_INTRO_HANDLE_INPUT:
        if (JOY_NEW((A_BUTTON | B_BUTTON)))
        {
            if (JOY_NEW(A_BUTTON))
            {
                sRowanSpeechResources->currentPage++;
            }
            else // B_BUTTON
            {
                if (sRowanSpeechResources->currentPage != PIKACHU_INTRO_PAGE_1)
                    sRowanSpeechResources->currentPage--;
                else
                    break;
            }
            PlaySE(SE_SELECT);
            if (sRowanSpeechResources->currentPage == NUM_PIKACHU_INTRO_PAGES)
            {
    ...
    case PIKACHU_INTRO_PRINT_PAGE_TEXT:
        ...
        {
            FillWindowPixelBuffer(tTextboxWindowId, PIXEL_FILL(0));
            AddTextPrinterParameterized4(tTextboxWindowId, FONT_NORMAL, 3, 5, 1, 0, sTextColor_DarkGray, 0, sPikachuIntro_Strings[sRowanSpeechResources->currentPage]);
            if (sRowanSpeechResources->currentPage == PIKACHU_INTRO_PAGE_1)
            {
                HofPCTopBar_Clear();
                HofPCTopBar_Print(gText_Next, 0, 1);
    ...
    default:
        ...
        {
            gMain.state = 0;
            sRowanSpeechResources->currentPage = 0;
            SetGpuReg(REG_OFFSET_WIN0H, 0);
            SetGpuReg(REG_OFFSET_WIN0V, 0);
            SetGpuReg(REG_OFFSET_WININ, 0);
            SetGpuReg(REG_OFFSET_WINOUT, 0);
...
static void Task_PikachuIntro_Clear(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        ...
        tTimer = 80;
        gTasks[taskId].func = Task_RowanSpeech_Init;
    }
}

static void Task_RowanSpeech_Init(u8 taskId)
{
    s16 *data = gTasks[taskId].data;
    u32 size = 0;
    if (tTimer != 0)
    ...
    {
        sRowanSpeechResources->rowanSpeechBackgroundTiles = malloc_and_decompress(sRowanSpeech_Background_Tiles, &size);
        LoadBgTiles(1, sRowanSpeechResources->rowanSpeechBackgroundTiles, size, 0);
        CopyToBgTilemapBuffer(1, sRowanSpeech_Background_Tilemap, 0, 0);
        CopyBgTilemapBufferToVram(1);
        CreatBunearySprite(taskId);
        ...
        tTimer = 80;
        ShowBg(2);
        gTasks[taskId].func = Task_RowanSpeech_WelcomeToTheWorld;
    }
}

static inline void RowanSpeechPrintMessage(const u8 *str, u8 speed, bool32 isStringVar4)
{
...
static void Task_RowanSpeech_WelcomeToTheWorld(u8 taskId)
{
    s16 *data = gTasks[taskId].data;
    if (!gPaletteFade.active)
    {
        ...
        {
            RowanSpeechPrintMessage(gRowanSpeech_Text_WelcomeToTheWorld, sRowanSpeechResources->textSpeed, FALSE);
            gTasks[taskId].func = Task_RowanSpeech_ThisWorld;
        }
    }
}

static void Task_RowanSpeech_ThisWorld(u8 taskId)
{
    if (!IsTextPrinterActive(WIN_INTRO_TEXTBOX))
    {
        RowanSpeechPrintMessage(gRowanSpeech_Text_ThisWorld, sRowanSpeechResources->textSpeed, FALSE);
        gTasks[taskId].tTimer = 30;
        gTasks[taskId].func = Task_RowanSpeech_ReleaseBunearyFromPokeBall;
    }
}

static void Task_RowanSpeech_ReleaseBunearyFromPokeBall(u8 taskId)
{
    s16 *data = gTasks[taskId].data;
    u8 spriteId;
    ...
    if (!IsTextPrinterActive(WIN_INTRO_TEXTBOX))
    {
        ...
        gTasks[taskId].func = Task_RowanSpeech_IsInhabitedFarAndWide;
        gTasks[taskId].tTimer = 0;
    }
}

static void Task_RowanSpeech_IsInhabitedFarAndWide(u8 taskId)
{
    if (IsCryFinished())
    {
        if (gTasks[taskId].tTimer >= 96)
            gTasks[taskId].func = Task_RowanSpeech_IStudyPokemon;
    }
    if (gTasks[taskId].tTimer < 0x4000)
    {
        ...
        {
            RowanSpeechPrintMessage(gRowanSpeech_Text_IsInhabitedFarAndWide, sRowanSpeechResources->textSpeed, FALSE);
            PlayCry_Normal(INTRO_SPECIES, 0);
        }
    }
}

static void Task_RowanSpeech_IStudyPokemon(u8 taskId)
{
    if (!IsTextPrinterActive(WIN_INTRO_TEXTBOX))
    {
        RowanSpeechPrintMessage(gRowanSpeech_Text_IStudyPokemon, sRowanSpeechResources->textSpeed, FALSE);
        gTasks[taskId].func = Task_RowanSpeech_ReturnBunearyToPokeBall;
    }
}

static void Task_RowanSpeech_ReturnBunearyToPokeBall(u8 taskId)
{
    u8 spriteId;
    ...
    if (!IsTextPrinterActive(WIN_INTRO_TEXTBOX))
    {
        ...
        gTasks[taskId].func = Task_RowanSpeech_TellMeALittleAboutYourself;
    }
}

static void Task_RowanSpeech_TellMeALittleAboutYourself(u8 taskId)
{
    s16 *data = gTasks[taskId].data;
    ...
    else
    {
        if (tTimer == 48)
        {
            DestroySprite(&gSprites[tBuenarySpriteId]);
        ...
        {
            RowanSpeechPrintMessage(gRowanSpeech_Text_TellMeALittleAboutYourself, sRowanSpeechResources->textSpeed, FALSE);
            gTasks[taskId].func = Task_RowanSpeech_FadeOutRowan;
        }
    }
}

static void Task_RowanSpeech_FadeOutRowan(u8 taskId)
{
    s16 *data = gTasks[taskId].data;
    ...
    if (!IsTextPrinterActive(WIN_INTRO_TEXTBOX))
    {
        ...
        tTimer = 48;
        gTasks[taskId].func = Task_RowanSpeech_AskPlayerGender;
    }
}

static void Task_RowanSpeech_AskPlayerGender(u8 taskId)
{
    s16 *data = gTasks[taskId].data;
    ...
    if (tTrainerPicFadeState != 0)
    {
        ...
        else
        {
            tTrainerPicPosX = -60;
            ClearTrainerPic();
            RowanSpeechPrintMessage(gRowanSpeech_Text_AskPlayerGender, sRowanSpeechResources->textSpeed, FALSE);
            gTasks[taskId].func = Task_RowanSpeech_ShowGenderOptions;
        }
    }
}

static void Task_RowanSpeech_ShowGenderOptions(u8 taskId)
{
    if (!IsTextPrinterActive(WIN_INTRO_TEXTBOX))
    {
        ...
        sRowanSpeechResources->textColor[0] = 1;
        sRowanSpeechResources->textColor[1] = 2;
        sRowanSpeechResources->textColor[2] = 3;
        AddTextPrinterParameterized3(gTasks[taskId].tMenuWindowId, FONT_NORMAL, 8, 1, sRowanSpeechResources->textColor, 0, gText_Boy);
        sRowanSpeechResources->textColor[0] = 1;
        sRowanSpeechResources->textColor[1] = 2;
        sRowanSpeechResources->textColor[2] = 3;
        AddTextPrinterParameterized3(gTasks[taskId].tMenuWindowId, FONT_NORMAL, 8, 17, sRowanSpeechResources->textColor, 0, gText_Girl);
        ...
        gTasks[taskId].func = Task_RowanSpeech_HandleGenderInput;
    }
}

static void Task_RowanSpeech_HandleGenderInput(u8 taskId)
{
    ...
    gTasks[taskId].func = Task_RowanSpeech_ClearGenderWindows;

}

static void Task_RowanSpeech_ClearGenderWindows(u8 taskId)
{
    s16 *data = gTasks[taskId].data;
    ...
    gTasks[taskId].func = Task_RowanSpeech_LoadPlayerPic;
}

static void Task_RowanSpeech_LoadPlayerPic(u8 taskId)
{
    ...
    gTasks[taskId].tTimer = 32;
    gTasks[taskId].func = Task_RowanSpeech_YourNameWhatIsIt;
}

static void Task_RowanSpeech_YourNameWhatIsIt(u8 taskId)
{
    s16 *data = gTasks[taskId].data;
    ...
    if (tTrainerPicFadeState != 0)
    {
        ...
        {
            tTrainerPicPosX = 0;
            RowanSpeechPrintMessage(gRowanSpeech_Text_YourNameWhatIsIt, sRowanSpeechResources->textSpeed, FALSE);
            gTasks[taskId].func = Task_RowanSpeech_FadeOutForPlayerNamingScreen;
        }
    }
}

static void Task_RowanSpeech_FadeOutForPlayerNamingScreen(u8 taskId)
{
    if (!IsTextPrinterActive(WIN_INTRO_TEXTBOX))
    {
        BeginNormalPaletteFade(PALETTES_ALL, 0, 0, 16, RGB_BLACK);
        sRowanSpeechResources->hasPlayerBeenNamed = FALSE;
        gTasks[taskId].func = Task_RowanSpeech_DoNamingScreen;
    }
}

static void Task_RowanSpeech_MoveRivalDisplayNameOptions(u8 taskId)
{
    s16 *data = gTasks[taskId].data;
    ...
    if (!IsTextPrinterActive(WIN_INTRO_TEXTBOX))
    {
        ...
        {
            tTrainerPicPosX = -60;
            PrintNameChoiceOptions(taskId, sRowanSpeechResources->hasPlayerBeenNamed);
            gTasks[taskId].func = Task_RowanSpeech_HandleRivalNameInput;
        }
    }
}

static void Task_RowanSpeech_RepeatNameQuestion(u8 taskId)
{
    PrintNameChoiceOptions(taskId, sRowanSpeechResources->hasPlayerBeenNamed);
    if (sRowanSpeechResources->hasPlayerBeenNamed == FALSE)
        RowanSpeechPrintMessage(gRowanSpeech_Text_YourNameWhatIsIt, 0, FALSE);
    else
        RowanSpeechPrintMessage(gRowanSpeech_Text_YourRivalsNameWhatWasIt, 0, FALSE);
    gTasks[taskId].func = Task_RowanSpeech_HandleRivalNameInput;
}

#define tNameNotConfirmed data[15]

static void Task_RowanSpeech_HandleRivalNameInput(u8 taskId)
{
    s16 *data = gTasks[taskId].data;
    ...
    case 4: //
        ...
        ClearStdWindowAndFrameToTransparent(tMenuWindowId, TRUE);
        RemoveWindow(tMenuWindowId);
        GetDefaultName(sRowanSpeechResources->hasPlayerBeenNamed, input - 1);
        tNameNotConfirmed = TRUE;
        gTasks[taskId].func = Task_RowanSpeech_ConfirmName;
        break;
    case MENU_B_PRESSED:
        break;
    }
...
static void Task_RowanSpeech_DoNamingScreen(u8 taskId)
{
    if (!gPaletteFade.active)
    {
        GetDefaultName(sRowanSpeechResources->hasPlayerBeenNamed, 0);
        if (sRowanSpeechResources->hasPlayerBeenNamed == FALSE)
        {
...
static void Task_RowanSpeech_ConfirmName(u8 taskId)
{
    s16 *data = gTasks[taskId].data;
    if (!gPaletteFade.active)
    {
        ...
        {
            if (sRowanSpeechResources->hasPlayerBeenNamed == FALSE)
                StringExpandPlaceholders(gStringVar4, gRowanSpeech_Text_SoYourNameIsPlayer);
            else
                StringExpandPlaceholders(gStringVar4, gRowanSpeech_Text_ConfirmRivalName);
            RowanSpeechPrintMessage(gStringVar4, sRowanSpeechResources->textSpeed, TRUE);
        ...
        else if (!IsTextPrinterActive(WIN_INTRO_TEXTBOX))
        {
            ...
            else
            {
                ...
                gTasks[taskId].func = Task_RowanSpeech_HandleConfirmNameInput;
            }
        }
    }
}

static void Task_RowanSpeech_HandleConfirmNameInput(u8 taskId)
{
    ...
    case 0: // YES
        ...
        if (sRowanSpeechResources->hasPlayerBeenNamed == FALSE)
        {
            ClearDialogWindowAndFrame(WIN_INTRO_TEXTBOX, TRUE);
            CreateFadeInTask(taskId, 2);
            gTasks[taskId].func = Task_RowanSpeech_FadeOutPlayerPic;
        }
        else
        {
            StringExpandPlaceholders(gStringVar4, gRowanSpeech_Text_RememberRivalsName);
            RowanSpeechPrintMessage(gStringVar4, sRowanSpeechResources->textSpeed, TRUE);
            gTasks[taskId].func = Task_RowanSpeech_FadeOutRivalPic;
        }
        break;
    case 1: // NO
    case MENU_B_PRESSED:
        ...
        if (sRowanSpeechResources->hasPlayerBeenNamed == FALSE)
            ...
            gTasks[taskId].func = Task_RowanSpeech_RepeatNameQuestion;
        break;
    }
}

static void Task_RowanSpeech_FadeOutPlayerPic(u8 taskId)
{
    s16 *data = gTasks[taskId].data;
    ...
    if (tTrainerPicFadeState != 0)
    {
        ...
        if (tTimer != 0)
            ...
            gTasks[taskId].func = Task_RowanSpeech_FadeInRivalPic;
    }
}

static void Task_RowanSpeech_FadeOutRivalPic(u8 taskId)
{
    if (!IsTextPrinterActive(WIN_INTRO_TEXTBOX))
    {
        ClearDialogWindowAndFrame(WIN_INTRO_TEXTBOX, TRUE);
        CreateFadeInTask(taskId, 2);
        gTasks[taskId].func = Task_RowanSpeech_ReshowPlayersPic;
    }
}

static void Task_RowanSpeech_FadeInRivalPic(u8 taskId)
{
    ChangeBgX(2, 0, BG_COORD_SET);
    ...
    CreateFadeOutTask(taskId, 2);
    gTasks[taskId].func = Task_RowanSpeech_AskRivalsName;
}

static void Task_RowanSpeech_AskRivalsName(u8 taskId)
{
    s16 *data = gTasks[taskId].data;

    if (tTrainerPicFadeState != 0)
    {
        RowanSpeechPrintMessage(gRowanSpeech_Text_WhatWasHisName, sRowanSpeechResources->textSpeed, FALSE);
        sRowanSpeechResources->hasPlayerBeenNamed = TRUE;
        gTasks[taskId].func = Task_RowanSpeech_MoveRivalDisplayNameOptions;
    }
}

static void Task_RowanSpeech_ReshowPlayersPic(u8 taskId)
{
    s16 *data = gTasks[taskId].data;
    ...
    if (tTrainerPicFadeState != 0)
    {
        ...
        else
        {
            ...
            ChangeBgX(2, 0, BG_COORD_SET);
            CreateFadeOutTask(taskId, 2);
            gTasks[taskId].func = Task_RowanSpeech_LetsGo;
        }
    }
}

static void Task_RowanSpeech_LetsGo(u8 taskId)
{
    if (gTasks[taskId].tTrainerPicFadeState != 0)
    {
        StringExpandPlaceholders(gStringVar4, gRowanSpeech_Text_LetsGo);
        RowanSpeechPrintMessage(gStringVar4, sRowanSpeechResources->textSpeed, TRUE);
        gTasks[taskId].tTimer = 30;
        gTasks[taskId].func = Task_RowanSpeech_FadeOutBGM;
    }
}

static void Task_RowanSpeech_FadeOutBGM(u8 taskId)
{
    if (!IsTextPrinterActive(WIN_INTRO_TEXTBOX))
    {
        ...
        {
            FadeOutBGM(4);
            gTasks[taskId].func = Task_RowanSpeech_SetUpExitAnimation;
        }
    }
}

// The sRowanSpeechResources struct's currentPage field is reused below as a timer for shrinking the player pic
#define shrinkTimer currentPage

static void Task_RowanSpeech_SetUpExitAnimation(u8 taskId)
{
    sRowanSpeechResources->shrinkTimer = 0;
    Task_RowanSpeech_SetUpDestroyPlatformSprites(taskId);
    Task_RowanSpeech_SetUpFadePlayerPicWhite(taskId);
    Task_RowanSpeech_SetUpShrinkPlayerPic(taskId);
}
...
static void Task_RowanSpeech_SetUpShrinkPlayerPic(u8 taskId)
{
    s16 *data = gTasks[taskId].data;
    ...
    gTasks[taskId].func = Task_RowanSpeech_ShrinkPlayerPic;
}

static void Task_RowanSpeech_ShrinkPlayerPic(u8 taskId)
{
    s16 *data = gTasks[taskId].data;
    s16 x, y;
    u16 oldScaleDelta;

    sRowanSpeechResources->shrinkTimer++;
    if (sRowanSpeechResources->shrinkTimer % 20 == 0)
    {
        if (sRowanSpeechResources->shrinkTimer == 40)
            PlaySE(SE_WARP_IN);
        ...
        if (tScaleDelta <= 96)
        {
            ...
            gTasks[taskId].func = Task_RowanSpeech_FadePlayerPicToBlack;
        }
    }
}
...
static void Task_RowanSpeech_SetUpDestroyPlatformSprites(u8 taskId)
{
    u8 taskId2 = CreateTask(Task_RowanSpeech_DestroyPlatformSprites, 1);
...
static void Task_RowanSpeech_DestroyPlatformSprites(u8 taskId)
{
    s16 *data = gTasks[taskId].data;
    if (!gPaletteFade.active)
    {
        if (tBGFadeStarted != 0)
        {
            ...
            // Task_RowanSpeech_SetUpDestroyPlatformSprites, the platform sprite
            ...
            // emulator at the end of the Rowan speech.
            DestroyPikachuOrPlatformSprites(taskId, SPRITE_TYPE_PLATFORM);
        }
        else
        {
...
static void Task_RowanSpeech_SetUpFadePlayerPicWhite(u8 taskId)
{
    u8 taskId2 = CreateTask(Task_RowanSpeech_FadePlayerPicWhite, 2);
    s16 *data = gTasks[taskId2].data;
...
static void Task_RowanSpeech_FadePlayerPicWhite(u8 taskId)
{
    s16 *data = gTasks[taskId].data;
    u8 i;
...
static void Task_RowanSpeech_FadePlayerPicToBlack(u8 taskId)
{
    ...
    else
    {
        ...
        gTasks[taskId].func = Task_RowanSpeech_WaitForFade;
    }
}

static void Task_RowanSpeech_WaitForFade(u8 taskId)
{
    if (!gPaletteFade.active)
        gTasks[taskId].func = Task_RowanSpeech_FreeResources;
}

static void Task_RowanSpeech_FreeResources(u8 taskId)
{
    FreeAllWindowBuffers();
    DestroyMonSpritesGfxManager(MON_SPR_GFX_MANAGER_A);
    Free(sRowanSpeechResources);
    sRowanSpeechResources = NULL;
...
static void CB2_ReturnFromNamingScreen(void)
{
    ...
    case 3:
        ...
        LoadPalette(sRowanSpeech_Background_Pals, BG_PLTT_ID(0), sizeof(sRowanSpeech_Background_Pals));
#else
        LoadPalette(sRowanSpeech_Background_Pals, BG_PLTT_ID(0), sizeof(sRowanSpeech_Background_Pals) + PLTT_SIZEOF(48));
#endif
        break;
    case 4:
        DecompressAndCopyTileDataToVram(1, sRowanSpeech_Background_Tiles, 0, 0, 0);
        break;
    case 5:
        if (FreeTempTileDataBuffersIfPossible())
            return;
        ...
        break;
    case 6:
        taskId = CreateTask(Task_RowanSpeech_ConfirmName, 0);
        if (sRowanSpeechResources->hasPlayerBeenNamed == FALSE)
        {
            if (gSaveBlock2Ptr->playerGender == MALE)
                LoadTrainerPic(MALE_PLAYER_PIC, 0);
...
static void CreateBunearySprite(u8 taskId)
{
    u8 spriteId;
    ...
    gTasks[taskId].tBunearySpriteId = spriteId;
}
...
static void CreatePikachuOrPlatformSprites(u8 taskId, u8 spriteType)
{
    ...
    case SPRITE_TYPE_PLATFORM:
        LoadCompressedSpriteSheet(&sRowanSpeech_Platform_SpriteSheet);
        LoadSpritePalette(&sRowanSpeech_Platform_SpritePalette);
        for (i = PIKACHU_BODY_PLATFORM_LEFT; i < NUM_PIKACHU_PLATFORM_SPRITES; i++)
        {
            spriteId = CreateSprite(&sRowanSpeech_Platform_SpriteTemplates[i], i * 32 + 88, 112, 1);
...
static void LoadTrainerPic(u16 whichPic, u16 tileOffset)
{
    ...
    case MALE_PLAYER_PIC:
        LoadPalette(sRowanSpeech_Red_Pal, BG_PLTT_ID(4), sizeof(sRowanSpeech_Red_Pal));
        DecompressDataWithHeaderVram(sRowanSpeech_Red_Tiles, (void *)VRAM + 0x600 + tileOffset);
        break;
    case FEMALE_PLAYER_PIC:
        LoadPalette(sRowanSpeech_Leaf_Pal, BG_PLTT_ID(4), sizeof(sRowanSpeech_Leaf_Pal));
        DecompressDataWithHeaderVram(sRowanSpeech_Leaf_Tiles, (void *)VRAM + 0x600 + tileOffset);
        break;
    case RIVAL_PIC:
        LoadPalette(sRowanSpeech_Rival_Pal, BG_PLTT_ID(6), sizeof(sRowanSpeech_Rival_Pal));
        DecompressDataWithHeaderVram(sRowanSpeech_Rival_Tiles, (void *)VRAM + 0x600 + tileOffset);
        break;
    case OAK_PIC:
        LoadPalette(sRowanSpeech_Rowan_Pal, BG_PLTT_ID(6), sizeof(sRowanSpeech_Rowan_Pal));
        DecompressDataWithHeaderVram(sRowanSpeech_Rowan_Tiles, (void *)VRAM + 0x600 + tileOffset);
        break;
    default:
        return;
    }

    sRowanSpeechResources->trainerPicTilemap = AllocZeroed(0x60);
    for (i = 0; i < 0x60; i++)
        ((u8 *)sRowanSpeechResources->trainerPicTilemap)[i] = i;
    FillBgTilemapBufferRect(2, 0, 0, 0, 32, 32, 16);
    CopyRectToBgTilemapBufferRect(2, sRowanSpeechResources->trainerPicTilemap, 0, 0, 8, 12, 11, 2, 8, 12, 16, (tileOffset / 64) + 24, 0);
    CopyBgTilemapBufferToVram(2);
    Free(sRowanSpeechResources->trainerPicTilemap);
    sRowanSpeechResources->trainerPicTilemap = 0;
}
